...
const translations: Translations = {
  ...
  exportToPdf: { ru: 'Скачать PDF (снимок)', kk: 'PDF жүктеп алу (сурет)' },
  exportOfficialPdf: { ru: '📄 Официальная PDF ведомость', kk: '📄 Ресми PDF ведомосы' },
  pdfSummaryTitle: { ru: 'СВОДНАЯ ВЕДОМОСТЬ ПОСЕЩАЕМОСТИ', kk: 'САБАҚҚА ҚАТЫСУДЫҢ ЖИЫНТЫҚ ВЕДОМОСІ' },
  pdfSummarySubtitle: { ru: 'Официальный документ учета и контроля посещаемости учащихся', kk: 'Оқушылардың сабаққа қатысуын есепке алу және бақылаудың ресми құжаты' },
  pdfGeneratedAt: { ru: 'Сформировано', kk: 'Құрылған уақыты' },
  pdfClassTeacher: { ru: 'Классный руководитель', kk: 'Сынып жетекшісі' },
  pdfSchoolAdmin: { ru: 'Дежурный администратор / Завуч', kk: 'Кезекші әкімші / Оқу ісі меңгерушісі' },
  pdfTotalStudents: { ru: 'Всего учащихся', kk: 'Барлық оқушылар' },
  pdfPresent: { ru: 'Присутствуют', kk: 'Қатысатындар' },
  pdfLate: { ru: 'Опоздали', kk: 'Кешіккендер' },
  pdfTotalAbsent: { ru: 'Всего отсутствуют', kk: 'Барлығы жоқтар' },
  pdfAttendanceRate: { ru: 'Процент посещаемости', kk: 'Қатысу пайызы' },
  pdfSignature: { ru: 'Подпись', kk: 'Қолы' },
  pdfSealPlace: { ru: 'М.П.', kk: 'М.О.' },
  pdfOfficialNotice: { ru: 'Документ сформирован автоматически в ИС «iBaqyla». Имеет статус официальной внутришкольной ведомости.', kk: 'Құжат «iBaqyla» АЖ-де автоматты түрде жасалған. Мектепішілік ресми ведомость мәртебесіне ие.' },
  pdfButtonLabel: { ru: 'PDF-ведомость класса', kk: 'Сыныптың PDF-ведомосы' },
  generatingPdf: { ru: 'Формирование PDF...', kk: 'PDF жасалуда...' },
  pdfDownloadSuccess: { ru: 'PDF ведомость успешно загружена!', kk: 'PDF ведомосы сәтті жүктелді!' },
